  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 p-4 flex flex-col items-center">
        ...
        <a 
            href="#assistant"
            className="mt-8 inline-flex items-center gap-2 bg-[--accent-primary] text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-[--accent-secondary] transition-transform duration-300 transform hover:scale-105 shadow-2xl shadow-[#cb997e]/40"
        >
